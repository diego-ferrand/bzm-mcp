...
def _get_summary_context() -> str:
    ...
    return (
        ...
        "When you need deeper analysis, troubleshooting guidance, or advanced reporting techniques, consult the BlazeMeter skill.\n"
        "Use the blazemeter_skills tool with action 'read_skill_resource_uri' and provide:\n"
        "- skill_resource_uri: 'blazemeter-skill-blazemeter-performance-testing://references/reporting.md'\n"
        "This resource contains comprehensive information about:\n"
        "- Filter Report Data and Advanced Search techniques\n"
        "- Comparing reports across multiple test executions\n"
        "- Understanding KPIs and their purpose\n"
        "- Monitoring and Post-Test Analysis best practices\n"
        "- Troubleshooting performance issues (also see 'blazemeter-skill-blazemeter-performance-testing://references/troubleshooting.md')\n"
        "Consult the skill when:\n"
        "- Metrics show anomalies that need deeper investigation\n"
        "- You need to compare this execution with previous runs\n"
        "- Error rates are high and root cause analysis is needed\n"
        "- Response times are inconsistent and require advanced filtering\n"
        "- Users ask for detailed explanations beyond basic metric definitions\n"
    )
